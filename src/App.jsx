            ...
            >
              <thead>
                <tr style={{ background: "#e9ecef" }}>
                  ...
                  <th style={th}>Loan Taken</th>
                  <th style={th}>Loan Paid</th>
                  <th style={th}>Loan O/S</th>
                  <th style={th}>Interest Paid</th>
                  <th style={th}>SC Paid</th>
                </tr>
              </thead>
...
{/*                     <td
    ...
    {getFinancialYear(y)}   {/* ✅ updated */}
      ...
      >
        <div style={{ overflowX: "auto",
                      maxHeight: "350px",   // 🔥 controls visible rows (~10)
                      overflowY: "auto",    // ✅ vertical scroll
                    }}>
          <table
            style={{
          ...
          >
            <thead>              
              <tr style={{ background: "#f1f5f9" }}>
                <th style={{ ...th, color: "#111827" }}>Member</th>
                <th style={{ ...th, color: "#111827" }}>Year</th>
                <th style={{ ...th, color: "#111827" }}>Month</th>
                <th style={{ ...th, color: "#111827" }}>M.P.S</th>
                <th style={{ ...th, color: "#111827" }}>Int Dem</th>
                <th style={{ ...th, color: "#111827" }}>Int Coll</th>
                <th style={{ ...th, color: "#111827" }}>Int O/S</th>
                <th style={{ ...th, color: "#111827" }}>Principal</th>
                <th style={{ ...th, color: "#111827" }}>Loan</th>
                <th style={{ ...th, color: "#111827" }}>Savings</th>
                <th style={{ ...th, color: "#111827" }}>SC</th>
